...
@app.route('/upload', methods=['POST']) # задаємо маршрут  для завантаження файлу
def upload_image():
...
@app.route('/image/<filename>', methods=['GET'])    # задаємо маршрут  для отримання файлу
...
@app.route('/delete/<filename>', methods=['DELETE'])    # задаємо маршрут  для видалення файлу
